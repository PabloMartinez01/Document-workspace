...
import {FolderToolbarComponent} from "./features/folder/components/folder-toolbar/folder-toolbar.component";
...
@Component({
  selector: 'app-root',
  standalone: true,
    imports: [RouterOutlet, DocumentEditorModule, FolderDocumentListComponent, FolderInfoComponent, FolderListComponent, FolderToolbarComponent, NgIf, SidebarComponent, UploadDropzoneComponent],
